...
* obeys pct-gfe-collection-bundle-1 and pct-gfe-collection-bundle-2 and pct-gfe-collection-bundle-3
...
* entry[gfe-bundle] ^short = "SHALL include contributing provider specific GFE bundle"
...
// TODO MEETING, is the GFE Submitter necessary on each and every GFE and do they have to be the same? If so, this requires the contributing provider to make a copy of the requesting provider, but to what end?)
