...
* entry[composition].resource only PCTGFEComposition
...
* entry[practitioner] ^definition = "GFE Packet initiating provider practitioner. An initiating provider SHALL be present as an initiating provider practitioner (in this slice) or an initiating provider organization (an entry in the organization slice), but not both."
